...
public class DatabaseHelper extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL("CREATE TABLE student ( student_id INTEGER, student_rollno TEXT NOT NULL, student_course INTEGER NOT NULL,student_attendance Text, student_semester INTEGER NOT NULL, PRIMARY KEY(student_id), FOREIGN KEY(student_id) REFERENCES user(user_id), FOREIGN KEY(student_course) REFERENCES courses(course_id) )");
